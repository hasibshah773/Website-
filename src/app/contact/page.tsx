...
import { Phone, MapPin, Clock, MessageCircle, Facebook, Instagram, ArrowRight } from "lucide-react";
      ...
      <section className="py-20 px-4 bg-card">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 text-primary text-sm font-semibold tracking-widest uppercase mb-4">
            <div className="w-8 h-px bg-primary" />Contact Us<div className="w-8 h-px bg-primary" />
          </div>
          <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground mb-6 leading-tight">
            Get in Touch<br /><span className="italic text-primary">We&apos;d Love to Help</span>
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
            Have questions about our services or want to discuss your requirements? Reach out and we'll be happy to assist you.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <div>
              <div className="inline-flex items-center gap-2 text-primary text-sm font-semibold tracking-widest uppercase mb-5">
                <div className="w-8 h-px bg-primary" />Visit Us
              </div>
              <h2 className="font-display text-2xl sm:text-3xl font-bold text-foreground mb-4">Our Studio Location</h2>
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm">College Row, 1st Lane<br />Barishal, Bangladesh</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg border border-card-border" data-testid="div-map">
              <iframe
                src="https://maps.google.com/maps?q=College+Row,+1st+Lane,+Barisal,+Bangladesh+8200&t=&z=17&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="380"
                style={{ border: 0 }}
                allowFullScreen
      ...
      <section className="py-16 px-4 bg-card">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {[
              { q: "How far in advance should I book?", a: "For bridal makeup, book 1–3 months ahead. For parties, 1–2 weeks in advance is ideal. Urgent appointments available based on availability." },
              { q: "Do you offer home service?", a: "Yes, we offer home service for bridal and special occasion makeup within Barishal. Please call to discuss details and pricing." },
              { q: "What products do you use?", a: "We use professional-grade, skin-friendly makeup brands. Products are selected for their quality, longevity, and suitability for all skin types." },
              { q: "How long does bridal makeup take?", a: "Bridal makeup typically takes 2–3 hours. We recommend arriving early or booking a trial session beforehand." },
            ].map((faq, i) => (
              <Card key={i} className="p-5 border-card-border" data-testid={`card-faq-${i}`}>
