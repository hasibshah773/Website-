...
const milestones = [
  { year: "2018", title: "Founded Dream Look", desc: "Started the journey with passion for beauty and makeup artistry in Barishal." },
  { year: "2019", title: "First 100 Brides", desc: "Reached the milestone of 100 happy brides and expanded service offerings." },
  { year: "2021", title: "Professional Training", desc: "Completed advanced bridal and editorial makeup courses to elevate our skills." },
  { year: "2024", title: "500+ Happy Clients", desc: "Proud to have served over 500 satisfied clients across Barishal." },
];
    ...
    <main className="pt-20">
      <section className="relative py-24 px-4 bg-card overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="w-full h-full bg-cover bg-center" style={{ backgroundImage: "url('/images/about-barsha.png')" }} />
        </div>
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 text-primary text-sm font-semibold tracking-widest uppercase mb-4">
            <div className="w-8 h-px bg-primary" />Our Story<div className="w-8 h-px bg-primary" />
          </div>
          <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground mb-6 leading-tight">
            About Dream Look<br /><span className="italic text-primary">Makeover by Barsha</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div className="relative">
              <div className="rounded-2xl overflow-hidden aspect-[3/4] shadow-2xl">
                <img src="/images/real-barsha-portrait.png" alt="Barsha - Professional Makeup Artist" className="w-full h-full object-cover" data-testid="img-about-barsha" />
              </div>
            ...
            <div>
              <div className="inline-flex items-center gap-2 text-primary text-sm font-semibold tracking-widest uppercase mb-4">
                <div className="w-8 h-px bg-primary" />Meet the Artist
              </div>
              <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-5 leading-tight">
                Barsha — Your Trusted<br /><span className="italic text-primary">Beauty Artist</span>
              </h2>
      ...
      <section className="py-20 px-4 bg-card">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 text-primary text-sm font-semibold tracking-widest uppercase mb-4">
              <div className="w-8 h-px bg-primary" />Our Values<div className="w-8 h-px bg-primary" />
            </div>
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-4">Mission & Vision</h2>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 text-primary text-sm font-semibold tracking-widest uppercase mb-4">
              <div className="w-8 h-px bg-primary" />Our Journey<div className="w-8 h-px bg-primary" />
            </div>
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-4">Milestones & Achievements</h2>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary/5 via-background to-primary/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-5">
            Ready to Experience<br /><span className="italic text-primary">Dream Look Quality?</span>
          </h2>
